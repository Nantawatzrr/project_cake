...
<body>
  ...
  <form action="cg_password.php" method="post">
  <div class="container">
    <div class="col-12">
    ...
    <span class="login100-form-title pb-2 mt-5">
						เปลี่ยนรหัสผ่าน
					</span>
              <div class="wrap-input100 validate-input mt-3">
						<input type="password" class="input100" name="password" aria-describedby="password" placeholder="Password">
                    ...
                    <div class="wrap-input100 validate-input mt-3" >
						<input type="password" class="input100" name="changepassword" aria-describedby="changepassword" placeholder="Changepassword">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
          ...
          <div class="container-login100-form-btn">
						<button name="cg_pass" type="submit" class="login100-form-btn">
                  CHANGEPASSWORD
						</button>
					</div>
    </div>
