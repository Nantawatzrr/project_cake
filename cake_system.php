<?php
    ...
    $sql_1 = "SELECT * FROM cakeproduct";
    $sql_2 = "SELECT * FROM cakeproduct";
    $qrs = $conn->query($sql_1);
    $qrs_2 = $conn->query($sql_2);
?>
...
<body>
  ...
  <div class="mt-5 me-5 ms-5">
        ...
        <form action="rs_cake.php" method="post">
        ...
        <div class="container">
                <div class="row">
                <div class="col">
                    <p class="text-center fs-3 mt-3">รหัสออเดอร์</p>
                    <div class="wrap-input100 validate-input" >
                            <input type="text" class="input100" name="id_rs" aria-describedby="order"  placeholder="กรกอเลขออเดอร์">
                  ...
                  <div class="col">
                    <p class="text-center fs-3 mt-3">เค้ก</p>
                    
                  <div class="wrap-input100 validate-input mt-3">
                                  <label for="department"></label>
                                  <select name="name_order" id="or_name" class="focus-input100 text-center ">
                                  <option value="">--- เลือกสินค้าที่ต้องการ ---</option>
                                  <?php
                                      while ($roww = $qrs->fetch(PDO::FETCH_OBJ)) {
                                    ?>
                                    
                                      <option value="<?php echo $roww->name_pd?>">
                                          <?php echo $roww->name_pd . " ราคา " . $roww->price?>
                                      </option>
                                    <?php
                                      }
                                    ?>
                  ...
                  <div class="col">
                  <p class="text-center fs-3 mt-3">ขนาด</p>
                  <div class="wrap-input100 validate-input mt-3">
                        <label for="class"></label>
                        <select name="size_pd" class="focus-input100 text-center ">
                        <option value="">--- กำหนดจำนวนขนาด ปอน ---</option>
                        <option value="1">--- 1 ปอน ---</option>
                        <option value="2">--- 2 ปอน ---</option>
                        <option value="3">--- 3 ปอน ---</option>
                        <option value="4">--- 4 ปอน ---</option>
                    </select>
                   </div>
                  </div>
                  <div class="col">
                  <p class="text-center fs-3 mt-3">กี่ชิ้น</p>
                  <div class="wrap-input100 validate-input mt-3">
                    <label for="class"></label>
                    <select name="qty_pd" class="focus-input100 text-center ">
                    <option value="">--- กำหนดจำนวนชิ้น ---</option>
                    <?php
                            foreach (range('1', '5') as $alphabet) {
                          ?>
                  ...
                  <div class="col">
                  <p class="text-center fs-3 mt-3">ราคาเค้ก</p>
                  <div class="wrap-input100 validate-input mt-3">
                    <label for="class"></label>
                    <select name="price_pd" class="focus-input100 text-center ">
                    <option value="">---  ---</option>
                    <option value="160">--- 160 บาท ---</option>
                    <option value="190">--- 190 บาท ---</option>
                    <option value="180">--- 180 บาท ---</option>
                    <option value="220">--- 220 บาท ---</option>
                    </select>
                    </div>
                  </div>
                </div>
              ...
              <div class="wrap-input100 validate-input" >
                            <input type="text" class="input100" name="name_rs" aria-describedby="email"  placeholder="รบกวนระบุชื่อผู้จอง">
                          <span class="focus-input100"></span>
                          <span class="symbol-input100">
                            <i class="fa fa-envelope" aria-hidden="true"></i>
                          </span>
                    ...
                    <div class="container-login100-form-btn mt-2">
						<button name="rs_cake" type="submit" class="login100-form-btn">
							จองสินค้า
						</button>
					</div>
        </form>
